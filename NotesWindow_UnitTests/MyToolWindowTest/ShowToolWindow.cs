...
using SteveHall.NotesWindow;

namespace NotesWindow_UnitTests.MyToolWindowTest
{
    [TestClass()]
    public class ShowToolWindowTest
    {
        ...
        {
            IVsPackage package = new NotesWindowPackage() as IVsPackage;
            ...
            MethodInfo method = typeof(NotesWindowPackage).GetMethod("ShowToolWindow", BindingFlags.NonPublic | BindingFlags.Instance);
